# local_lernhive_configuration — Features

## Feature summary
Stores flavour overrides and configuration history for transparency and partner collaboration.

## Planned feature set
- override storage
- change history
- configuration comparison
- customer-visible configuration summary
