...
- **0.3.0 target** — feature-registry integration (consumer of ADR-01), Level-1 assignment tour migration to Level 2, new Level 2–5 tour packs per the v2 review of `level-tour-matrix.md`.
- **R1 envelope** — all five level packs, feature-driven visibility, LXP-flavor participant audience.
