...
/**
 * Reporting dashboard entry page.
 *
...
use local_lernhive_reporting\output\dashboard_page;
...
$PAGE->set_url(new moodle_url('/local/lernhive_reporting/index.php', ['courseid' => $courseid]));
$PAGE->set_pagelayout('standard');
$PAGE->set_title(get_string('pluginname', 'local_lernhive_reporting'));
...
echo $OUTPUT->header();
echo $renderer->render_dashboard_page(new dashboard_page($courseid));
echo $OUTPUT->footer();
