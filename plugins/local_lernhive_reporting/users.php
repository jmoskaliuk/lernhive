...
/**
 * Users-in-course drilldown report.
 *
...
$PAGE->set_title(get_string('tile_users_title', 'local_lernhive_reporting'));
...
echo $OUTPUT->header();
echo $renderer->render_users_page(new users_page($courseid));
echo $OUTPUT->footer();
