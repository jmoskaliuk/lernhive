...
$string['privacy'] = 'Datenschutz & Cookies';
$string['hero_tagline'] = 'Dein Lernportal — einfach. effektiv.';
$string['hero_desc'] = 'LernHive bringt Trainer/innen und Lernende zusammen. Interaktive Kurse, geführte Lernpfade und smarte Tools — alles an einem Ort.';
$string['hero_feature1_title'] = 'Geführte Lernpfade';
$string['hero_feature1_desc'] = 'Schritt-für-Schritt durch jede Fähigkeit — mit interaktiven Touren und Checkpoints.';
$string['hero_feature2_title'] = 'Flexibles Lernen';
$string['hero_feature2_desc'] = 'Kurze Snacks oder tiefe Kurse — in deinem Tempo, auf jedem Gerät.';
$string['hero_feature3_title'] = 'Community & Austausch';
$string['hero_feature3_desc'] = 'Verbinde dich mit Kolleg/innen, teile Inhalte und lerne gemeinsam.';
$string['hero_availablecourses'] = 'Verfügbare Kurse';
